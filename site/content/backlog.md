...
- **담당(2026-07-14 확정): 인터랙션 디자이너님 메인의 병렬 트랙.** 주미님 몫은 검토 + 디자인 시스템 연결(브랜드 값의 토큰 반영)만.
- 접점: MVP 일정(prism plan-19)과 W1 킥오프(freeze 날짜 합의, 목표 8/22) · W7 브랜드 토큰 반영 · W8 로고 에셋(온보딩·스플래시)으로 물림.
