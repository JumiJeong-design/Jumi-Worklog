...
> Last updated: 2026-08-03 (전면 갱신은 07-16 기준 · 07-28에 Quick/Deep 결과 화면 + 라벨 뱃지 계열·타이포 램프·브랜치 캐비엇 갱신 · 07-29에 스킬 검증·오탐 수정 반영 · 07-30~31에 prism npm 배포 재개와 `prism-dist` 은퇴 반영 · 08-03에 색 규칙 확정(구간 3색)·PR 4건 머지·Version PR #43·감사표 수치 재정정 반영)
>
...
- **형제 칩 포팅** — `SourceChip`(2변형, 쉬움) → `Attachment/Chip`(8변형). `ModelChip`·`ChipGroup`은 ideation 승격이 선행.
