...
- **경계는 「껍데기=DS · 본문=제품」이다.** 모달 본문은 DS로 올렸지만(`Modal Content` 5종) **시트 본문은 제품 파일에 남긴다** — 파일 간 노드 이동이 API에 없어 2955px 중첩 본문은 손으로 재현하면 흘린다. 제품 쪽 `Sheet Body` 9개는 전용 섹션에 수납돼 있다.
